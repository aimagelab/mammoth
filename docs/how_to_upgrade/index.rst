...
- The *end_eval* hook is available as an optional method: `def end_eval(self, dataset, accs) -> None`. Use it for post-evaluation logic that depends on the computed accuracies.
