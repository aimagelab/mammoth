...
class XDerCe(ContinualModel):
    ...
    def get_parser(parser) -> ArgumentParser:
        ...
        parser.add_argument('--constr_eta', type=float, default=0.01, help='Regularization weight for past/future constraints')  # constr_weight
    ...
    def observe(self, inputs, labels, not_aug_inputs, epoch=None):
        ...
        loss = loss_stream + loss_der + loss_derpp + loss_constr_futu
